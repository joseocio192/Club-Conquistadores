                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="tdAsistencia">
                                ...
                                <select class="selectPulcritud" name="pulcritud_{{ $asistencia->pivot->id_asistencia . '-' . $asistencia->pivot->id_conquistador }}">
            ...
            <form action={{ route('instructor.sendRequisitos') }} method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="tdTareas">
                            <input type="checkbox" name="{{ $requisitoss->pivot->requisito_id . '-' . $requisitoss->pivot->conquistador_id }}" value="1" @if ($requisitoss->pivot->completado == 1) checked @endif>
                        </td>
                        @endif
                        @endforeach
                    </tr>
