        ...
        <ul>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="checkbox" onclick="return false;" name="{{ $tareaa->pivot->tarea_id . '-' . $tareaa->pivot->conquistador }}" value="1" @if ($tareaa->pivot->completada == 1) checked @endif>
                                @endif
                            </td>
                            @endforeach
                        </tr>
            ...
            <div class="divTarea">
                ...
                <div>
                    ...
                    <h3>@lang('app.id_:') {{ $tarea->id }}</h3>
                    <h3>@lang('app.nombre') {{ $tarea->nombre }}</h3>
                </div>
                <h3>@lang('app.description') {{ $tarea->descripcion }}</h3>
                <h3>@lang('app.date') {{ $tarea->fecha }}</h3>
            </div>
            @endif

            @if ($status == 'especialidad')
            <h1>@lang('app.speciality')</h1>
            ...
            <h3>Requisitos de la especialidad</h3>
            ...
            @else
            <h2>@lang('app.specialties_started_but_not_completed')</h2>
